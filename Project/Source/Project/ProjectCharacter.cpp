...
void AProjectCharacter::UpdateAnimation()
{
...
void AProjectCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	// Note: the 'Jump' action and the 'MoveRight' axis are bound to actual keys/buttons/sticks in DefaultInput.ini (editable from Project Settings..Input)
	InputComponent->BindAction("Jump", IE_Pressed, this, &ACharacter::Jump);
	InputComponent->BindAction("Jump", IE_Released, this, &ACharacter::StopJumping);
	InputComponent->BindAxis("MoveRight", this, &AProjectCharacter::MoveRight);

	InputComponent->BindTouch(IE_Pressed, this, &AProjectCharacter::TouchStarted);
	InputComponent->BindTouch(IE_Released, this, &AProjectCharacter::TouchStopped);
}
...
void AProjectCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// jump on any touch
	Jump();
}

void AProjectCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	StopJumping();
}

void AProjectCharacter::UpdateCharacter()
{
